...
local t = {"Esper Raid", "Tengoku Raid", "Hirito Raid", "Titan Raid", "Infinity Nojo Raid", "Gear 5 Fluffy Raid", "Demon Lord Raid", "Yomiichi Raid", "Christmas Raid", "Combat Titan Raid"}
local u = loadstring(game:HttpGet("https://raw.githubusercontent.com/shlexware/Orion/main/source"))()
local v = u:MakeWindow({Name = "🌊Wave Hub", HidePremium = true})
...
D:AddLabel("If you get kicked, select behind")
z:AddTextbox(
    {
        Name = "Put @here or @everyone if you dont wanna use id",
...
y:AddLabel("If you get no reward, just adjust value")
G:AddButton(
    {Name = "Script by 🌊Wave Hub", Callback = function()
...
u:MakeNotification({Name = "🌊Wave Hub", Content = "Game: Anime Dimension", Time = 15})
u:Init()
